    ...
    return (
      <View style={{ marginBottom: 20 }}>
          ...
          <View >
            <TextInput
              autoCapitalize="none"
              style={{ marginBottom: 0, marginTop: 5, height: 35, width: 250, fontSize: 15, backgroundColor: '#e7e7e7', borderRadius: 0, paddingHorizontal: 10, paddingBottom: 0, paddingTop:0 }}
